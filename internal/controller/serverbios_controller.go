...
func (r *ServerBIOSReconciler) reconcileScan(
	...
	updateRequired := !(serverBIOS.Status.BIOS.Version == serverBIOSBase.Status.BIOS.Version) ||
		!cmp.Equal(serverBIOS.Status.BIOS.Settings, serverBIOSBase.Status.BIOS.Settings)
